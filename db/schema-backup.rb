...
ActiveRecord::Schema.define(version: 2018_09_03_170733) do
  ...
  add_foreign_key "project_developers_tables", "projects"
  add_foreign_key "project_developers_tables", "users"
