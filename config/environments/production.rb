Rails.application.configure do
  ...
  config.eager_load = false #TODO:  Possibly enable this after we test if n+1 queries are the memory issue
  ...
  # config.active_job.queue_name_prefix = "jewlerCRM_#{Rails.env}"
