window.onload = function() {
    var expanded = ko.observable(true),
        expandButtonIcon = ko.observable("chevrondown"),
        expandButtonHint = ko.observable("Collapse All");
    
    expanded.subscribe(function(newValue) {
        expandButtonIcon(newValue ? "chevrondown": "chevronnext");
        expandButtonHint(newValue ? "Collapse All" : "Expand All");
    });
