$(function(){
    var scheduler = $("#scheduler").dxScheduler({
        ...
        dropDownAppointmentTemplate: function(data, index, container) {
            return getAppointmentTemplate(data);
        },
        appointmentTooltipTemplate: function(data, index, container) {
            return getAppointmentTemplate(data);
        },
    ...
    function getAppointmentTemplate(data) {
        var color = getAppointmentColor(data.roomId);

        var markup = $("<div class='appointment-content'>" +
                    "<div class='appointment-badge' style='background-color:" + color + ";'>" + data.text[0] +
                    "</div>" +
