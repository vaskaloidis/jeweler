        ...
        mapMarkers: [
            {
                ...
                onClick: function () { DevExpress.ui.notify("Marker 'A' onClicked!", "info", 1000); }
            },
            {
                title: "B marker",
                location: [40.749825, -73.987963],
                onClick: function () { DevExpress.ui.notify("Marker 'B' onClicked!", "info", 1000); }
            },
            {
                title: "C marker",
                location: [40.755823, -73.986397],
                onClick: function () { DevExpress.ui.notify("Marker 'C' onClicked!", "info", 1000); }
            }
        ],
